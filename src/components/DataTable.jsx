...
export default function DataTable(props) {
  ...
  return <div class="flex h-full w-full flex-col overflow-auto rounded-box border border-base-300 bg-base-100 shadow-sm">
    <table class="table table-sm md:table-md"><thead class="sticky top-0 z-10 bg-base-200 shadow-sm"><tr><For each={columns()}>{field => <th scope="col">{field.label}</th>}</For><th scope="col" class="text-right">Actions</th></tr></thead>
