    ...
    >
      <summary class="flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3 text-sm font-semibold sm:px-5">
        <span class="flex items-center gap-2">
          <Filter size={16} class="text-primary" /> Query builder
          <span class="badge badge-ghost badge-sm">
            {props.draft.filters.length} filters
          </span>
          ...
          <div class="flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex w-full gap-2 sm:w-auto">
              <select
                ...
                onChange={(event) =>
                  setFilterFieldId(event.currentTarget.value)
                }
              >
                <option value="">
            ...
            <div class="space-y-3">
              ...
              <div class="flex gap-2">
                <select
                  ...
                  onChange={(event) =>
                    setSortFieldId(event.currentTarget.value)
                  }
                >
                  <option value="">
